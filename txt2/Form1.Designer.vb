...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        ' txtName
        ' 
        txtName.Location = New Point(276, 60)
        ...
        ' txtSurname
        ' 
        txtSurname.Location = New Point(276, 122)
        ...
        ' txtGender
        ' 
        txtGender.Location = New Point(276, 189)
        ...
        ' Button1
        ' 
        Button1.Location = New Point(319, 284)
        Button1.Name = "Button1"
        Button1.Size = New Size(143, 45)
        Button1.TabIndex = 6
        Button1.Text = "Great Me"
